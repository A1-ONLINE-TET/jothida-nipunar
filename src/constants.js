...
// Classical vedha pairs (0-based nakshatra indices); Chitra (13) has no vedha
export const VEDHA_PAIRS = [[0,17],[1,16],[2,15],[3,14],[4,22],[5,21],[6,20],[7,19],[8,18],[9,26],[10,25],[11,24],[12,23]];
...
export const SUBA_NAKSHATRAS = [0,3,4,6,7,11,12,13,14,16,20,21,25,26]; // Ashwini,Rohini,Mrigasira,Punarvasu,Pushya,Uttiram,Hastam,Chitra,Swati,Anusham,Uttiradam,Thiruvonam,Uttirattathi,Revathi
